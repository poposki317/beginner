...
class PalindromeString(str):
    """This class IS-A string. That means inherits from Python's string class."""
    def is_palindrome(self):
        """Calling this method on a string returns a Boolean to indicate whether the word is a palindrome or not. """
        self = self.replace(' ','')
